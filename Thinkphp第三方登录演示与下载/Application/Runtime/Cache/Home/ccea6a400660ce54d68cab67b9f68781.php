    ...
    <body> 
        ...
        <div id='nav' class='nav'>
            <div class='nav_main clearfix'>
                ...
                <a href='/jquery/2/288/demo/psd' class="menu<?php echo (getequal($control,'psd',' current')); ?>">网站psd</a>
                <?php if(C("DB_PWD")== ''): ?><a href='/jquery/2/288/demo/source' class="menu<?php echo (getequal($control,'source',' current')); ?>">网站源码</a><?php endif; ?>
                <?php if(C("DB_PWD")== ''): ?><a href='/jquery/2/288/demo/answer' class="menu<?php echo (getequal($control,'answer',' current')); ?>">有问必答</a><?php endif; ?>
                <a href='/jquery/2/288/demo/site' class="menu<?php echo (getequal($control,'site',' current')); ?>">精选网址</a>
                <a href='/jquery/2/288/demo/tools' class="menu<?php echo (getequal($control,'tools',' current')); ?>">工具箱</a>
                <span class='icon_hot'></span>
            </div>
        </div>
<link rel="stylesheet" href="/jquery/2/288/demo/other/login/css/base.css" />
<div class="wrap_outer">
    <section class="wrap">
        <div class="pop-title">
            ...
            <a class="a_underline" href="/jquery/2/288/demo/reg.html">注册</a>    
        </div>
